...
export const projectsData = {
  ...
  "top-threads": {
    title: "Top.Threads",
    fullDescription: "Перший український агрегатор трендів у Threads. Додаток автоматично сканує медіапростір, відбираючи найпопулярніші пости за останні 24 години та тиждень. Це незамінний інструмент для SMM-спеціалістів та авторів: він дозволяє миттєво бачити, які теми та формати зараз 'вірусяться', аналізувати реакції аудиторії та знаходити натхнення для власного контенту без нескінченного скролінгу стрічки.",
    features: [
